...
class TestDigitalLibrary(unittest.TestCase):
    ...
    def test_add_txt(self):
        ...
        self.assertEqual(document.small_thumbnail_abspath, None)
        self.assertEqual(document.normal_thumbnail_abspath, None)
        self.assertEqual(document.large_thumbnail_abspath, None)
    ...
    def test_add_pdf(self):
        ...
        self.assertNotEqual(document.small_thumbnail_abspath, None)
        self.assertNotEqual(document.normal_thumbnail_abspath, None)
        self.assertNotEqual(document.large_thumbnail_abspath, None)
